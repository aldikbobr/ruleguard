...
[Live demo](https://ruleguard-rho.vercel.app/) · [Pitch deck](https://aldikbobr.github.io/ruleguard-deck/) · [Findings](research/FINDINGS.md) · [Docs](docs/) · Video walkthrough (coming soon)
...
- [Live demo](https://ruleguard-rho.vercel.app/): live prices, ↻ on every pair, "Refresh all pairs" and auto-refresh; pairs matched on Sep 25, 2026 (static copy: [GitHub Pages](https://aldikbobr.github.io/ruleguard/))
